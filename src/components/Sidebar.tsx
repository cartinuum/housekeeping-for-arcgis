...
// ArcGIS Online /search caps total at 10,000 regardless of actual count.
function formatOrgTotal(total: number): string {
  return total >= 10_000 ? '10,000+' : total.toLocaleString()
}
            ...
            <div style={{ display: 'flex', gap: '0.5rem', width: '100%' }}>
              <div style={{
                ...
                <div style={{ fontWeight: 700, fontSize: 15 }}
                  title={viewScope === 'org' && (orgTotal ?? 0) >= 10_000
                    ? 'ArcGIS Online search returns a maximum of 10,000 — the org may have more items'
                    : undefined}>
                  {viewScope === 'org'
                    ? formatOrgTotal(orgTotal ?? items.length)
